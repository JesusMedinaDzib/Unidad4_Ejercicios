...
MSJ2 DB 0AH,0DH, 'INGRESE EL PRIMER NUMERO: ', '$'
MSJ3 DB 0AH,0DH, 'INGRESE EL SEGUNDO NUMERO: ', '$'
MSJ4 DB 0AH,0DH, 'INGRESE TERCER NUMERO: ', '$'
...
MENSAJEMAYOR:
MOV DX, OFFSET MAYOR ;IMPRIME EL MAYOR
MOV AH, 9
INT 21H

RET
PEDIRCARACTER:
MOV AH,01H; PEDIMOS EL PRIMER NUMERO
INT 21H
RET
...
EXIT:
MOV AX, 4C00H;4C DE LA INTERRUPCION 21H
